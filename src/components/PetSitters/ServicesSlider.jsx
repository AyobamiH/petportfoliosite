      ...
      <div className="min-h-[calc(100vh-64px)] py-4 mb-4 relative">
        ...
        <div className="w-full text-center max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
                ...
                <div key={service.id} className="min-w-full flex flex-col py-2 items-center">
                  <div className="w-full rounded-lg mx-auto">
                    <img
                      src={service.image}
                      alt={service.title}
                      className="mx-auto w-3/4 sm:w-1/2 lg:w-1/3"
                    />
                  </div>
                </div>
              ))}
          ...
          <div className="relative w-full lg:w-4/5 overflow-hidden">
            ...
            >
              {services.map((service) => (
                <div key={service.id} className="min-w-full mx-auto flex flex-col items-center bg-white px-4 lg:px-8">
                  <div className="w-full h-auto shadow-lg justify-center p-6 rounded-lg">
                    <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4">
                      {service.title}
                    </h3>
                    <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6">
                      {service.description}
                    </p>
                    <AnimatedButton className="bg-orange-500 py-2 px-4 sm:py-3 sm:px-6 text-sm sm:text-base md:text-lg">
                      Learn More
                    </AnimatedButton>
                  </div>
                </div>
